# Adapted from the MIT licensed works of:
# https://github.com/custom-components/zaptec/graphs/contributors
...
if __name__ == "__main__":
    ...
    async def gogo():
        username = os.environ.get("ZAPTEC_USER")
        password = os.environ.get("ZAPTEC_PW")
        ...
        for charger in acc.stand_alone_chargers:
            print(
                "BBBBBBBBBBBBBBBBBBBBBAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"
            )
