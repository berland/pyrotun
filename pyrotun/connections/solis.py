# Based on https://github.com/ZuinigeRijder/SolisCloud2PVOutput (Apache 2 License)
...
class SolisConnection:
    ...
    async def get_solis_cloud_data(self, url_part, data) -> dict:
        ...
        content = await self.execute_request(self.api_url + url_part, data, headers)
        return content

    async def execute_request(self, url, data, headers) -> dict:
